...
<p>
      Si l’affichage échoue, une version statique est fournie dans le dépôt GitHub, dans le fichier <code>data/rapport/SHINY.pdf</code> contenant des captures d’écran détaillées. Un bouton est également disponible dans le document pour accéder directement au site en ligne.
</p>
</div>
</div>
