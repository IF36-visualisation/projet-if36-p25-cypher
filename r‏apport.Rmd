...
output:
  html_document:
    css: 
    - data/rapport/custom.css
    - data/rapport/bootstrap.min.css
    toc: true
    toc_float: true
...
Ce graphique présente l'évolution mensuelle des retards de trains en France de **2015 à 2020**.  
  ...
  <img src="data/rapport/au_fil_des_mois.png" style="border-radius: 8px; max-width: 50%; margin-bottom: 1rem;" alt="Évolution mensuelle">
  </div>
<div class="card text-white bg-primary mb-3">
  <div class="card-header">Interprétation</div>
  <div class="card-body">
...
Pas possible d'être possible à la date près (car uniquement des données du mois et pas de jours) donc on a arrondis au mois (exemple : 21 décembre -> 1er janvier pour le début de l'hiver.)
 ...
 <div style="text-align:center;">
  <img src="data/rapport/au_fil_des_saisons.png" style="border-radius: 8px; max-width: 80%; margin-bottom: 1rem;" alt="Évolution mensuelle">
  </div>
<div class="card text-white bg-primary mb-3">
  <div class="card-header">Interprétation</div>
  <div class="card-body">
...
<div class="card text-white bg-success mb-3">
  <div class="card-header">Bilan</div>
  <div class="card-body">
  <p>Au terme de cette analyse, rappelons les trois grandes questions qui ont guidé notre exploration :</p>

  <ul>
    <li><b>Comment la ponctualité évolue-t-elle au fil des mois ?</b></li>
      <li><b>Y a-t-il des saisons où les retards sont plus fréquents ?</b></li>
      <li><b>Peut-on identifier des flux ferroviaires particulièrement sensibles ?</b></li>
    </ul>

  <p>Les résultats obtenus montrent qu’il n’existe <b>pas de pattern cyclique strict</b> dans l’évolution mensuelle de la ponctualité. Au contraire, on observe <b>une variabilité constante</b> d’une année à l’autre, sans saisonnalité parfaitement récurrente.</p>

  <p>Cependant, certaines tendances se dégagent : les <b>mois de mai, juin, juillet et août</b> présentent régulièrement des pics de retard, ce qui suggère une <b>accumulation des retards au printemps et en été</b>. Ces périodes coïncident avec les <i>ponts du mois de mai</i> et les <i>vacances estivales</i>, deux moments où l’affluence sur le réseau est particulièrement élevée.</p>

   <p>Enfin, les heatmaps révèlent que les retards sont principalement concentrés dans les <b>grandes gares parisiennes</b> (Montparnasse, Lyon, Est), ce qui s’explique par leur rôle central dans le réseau ferroviaire national. Ces gares, véritables nœuds de correspondance, sont plus exposées aux effets de saturation, aux correspondances multiples, et aux retards en cascade.</p>
  <p>Ce bilan met en lumière des <b>axes ferroviaires particulièrement sensibles</b>, notamment entre Paris et les grandes métropoles régionales, et ouvre la voie à des analyses plus fines sur les causes sous-jacentes de ces retards.</p>
  </div>
</div>
...
# Impact des saisons/conditions météorologiques 

## Les conditions météorologiques extrêmes impactent-elles les retards moyens de train ?

<p align ="justify">
Nous souhaitons analyser si les conditions météorologiques (chaleur intense ou neige) peuvent avoir un impact sur les retards de trains en fonction de la position géographique des villes. Il est important de prendre en compte que les périodes étudiées, été et hiver, diffèrent fortement en termes de trafic : l’été connaît bien plus de déplacements en train que l’hiver, ce qui peut également influencer les résultats. Nous nous attendons néanmoins à observer une différence notable du retard moyen entre ces deux saisons selon les régions. Par exemple, nous supposons que les régions alpines sont potentiellement plus impactées par les conditions hivernales (notamment les chutes de neige), tandis que les régions du sud pourraient être davantage touchées en été, en raison des fortes chaleurs et d’une affluence plus importante.
</p>
...
- Egalement, on peut remarquer que les retards dûs aux causes matérielles et de retard en station ont la même proportion environ pour chaque mois. Les retards pour cause de gestion de trafic également, même si on peut voir une augmentation entre juin et juillet. Il est alors que 
l'affluance des vacances d'été font que plus de trains sont mobilisés, et donc cela amène a plus de difficultés d'organisation.
  </div>
</div>
...
- Les **villes parisiennes** observent **la plus grande proportion** de **retard en station**. Cela peut être expliqué par le fait que ces gares sont sujettes à un grand nombre d'arrivées et de départs, et avec la réutilisation de trains pour certaines lignes par exemple.

- Pour ces mêmes gares, la proportion de retards pour **matériel roulant** est aussi notable, ce qui rejoint ce qu'on vient de dire par rapport à la réutilisation de rames par exemple
  </div>
</div>

## Bilan des causes de retards 
...
<br>
Les causes extérieures, souvent dûes à la météo, sont plus fréquentes lors des saisons plus froides et aux stations les plus exposées face à ce
type de climat
<br>
Les périodes de vacances, surtout celles d'été, ont un impact remarquable sur certaines causes de retard, ce qui rejoint ce qu'on a vu précédemment
<br>
En règle générale, nous povons remarquer que les retards pour cause d'infrastructure ou de matériel roulant, combinés, occupent de manière constante près de la moitié des causes de retard. On pourrait alors se poser des questions sur tout le matériel appartenant à la SNCF.
Ce matériel a bien entendu besoin de maintenance, mais pas. au point de compromettre autant la circulation du réseau. Par exemple, certaines
rames roulent alors qu'elles ont plus de 50 ans. Cette vétusté engendre mécaniquement des pannes, des ralentissements, voire des interruptions de circulation, rendant ces deux facteurs structurellement dominants dans les causes de retard.
</p>
 </div>
</div>
...
<div class="card-body">
<p>
L’analyse du nuage de points entre la durée des trajets et le retard moyen met en évidence une <b>tendance générale modérée</b> : la droite de régression présente une <b>légère pente positive</b>, ce qui suggère qu’<b>un allongement de la durée du trajet s’accompagne d’une augmentation modeste du retard moyen</b>. Toutefois, cette corrélation demeure <b>faible</b>, comme en témoigne la grande dispersion des points autour de la droite.

On observe que <b>la majorité des trajets, quelle que soit leur durée, présentent des retards inférieurs à 20 minutes</b>, ce qui traduit une <b>ponctualité globalement bien maîtrisée</b>. Les <b>trajets courts (moins de 60 minutes)</b> sont particulièrement réguliers, avec des retards très faibles (<10 min), tandis que les <b>trajets moyens (60 à 250 minutes)</b> montrent une plus grande variabilité, bien que les cas extrêmes restent rares. Pour les <b>trajets longs (>250 minutes)</b>, une légère hausse du retard médian est perceptible, sans que cela ne compromette significativement la régularité globale.

Enfin, la présence de <b>quelques valeurs extrêmes</b> (retards supérieurs à 60 minutes) ne remet pas en cause la tendance principale et souligne que <b>la durée du trajet n’est qu’un facteur partiel parmi d’autres dans l’explication des retards</b>.
</p>
...
<div class="card-body">
<p>
La <b>ligne pointillée rouge</b> représente la <b>médiane globale des retards</b>, située autour de <b>cinq minutes</b>. Pour les <b>trajets courts</b> (jusqu’à 90 minutes), la médiane spécifique à chaque tranche reste <b>proche ou inférieure à cette valeur de référence</b> et la <b>dispersion est très faible</b>, traduisant une <b>ponctualité remarquable</b> sur ces segments.

Entre <b>90 et 240 minutes</b>, on observe une <b>progression graduelle de la médiane</b> et un <b>élargissement de l’intervalle interquartile</b>. Quelques <b>valeurs extrêmes</b> apparaissent (jusqu’à 30 voire 80 minutes), mais la <b>grande majorité des retards reste concentrée sous les 15 minutes</b>.

Au-delà de <b>240 minutes</b>, la médiane dépasse de manière plus systématique la ligne de référence et la <b>variabilité devient plus marquée</b>. Les tranches comprises entre <b>270 et 330 minutes</b> affichent la plus forte dispersion, avec des <b>retards médians autour de 8 à 10 minutes</b>. Pour la dernière tranche (360 à 390 minutes), la médiane <b>diminue légèrement</b>, probablement en raison d’un <b>nombre plus faible d’observations</b>.

En résumé, la relation entre <b>durée du trajet et retard</b> est <b>légèrement positive</b> : un voyage plus long est associé à une légère hausse du retard médian. Toutefois, <b>la moitié des trains, toutes durées confondues, continuent d’arriver avec moins de 10 minutes de retard</b>, ce qui témoigne d’une <b>maîtrise globale des délais</b>.
</p>
...
<div class="card border-primary mb-3" style="font-size: 1.3rem;">
<div class="card-header">Aperçu de l'application</div>
<div class="card-body">
<p>
    Voici un aperçu de notre application <b>Shiny interactive</b>, hébergée sur <b>shinyapps.io</b>. Elle est consultable en ligne afin d’explorer les différentes analyses réalisées (saisonnalité, flux, retards, etc.).
  </p>
<p>
  Pour visualiser correctement l’application, il est recommandé de cliquer sur le bouton <b>“Open in Browser”</b> (ouvrir dans le navigateur) si elle ne s’affiche pas localement dans le viewer RStudio.
</p>
<p>
      Si l’affichage échoue, une version statique est fournie dans le dépôt GitHub, dans le fichier <code>data/rapport/Shiny_screenshots</code> contenant des captures d’écran détaillées. Un bouton est également disponible dans le document pour accéder directement au site en ligne.
</p>
</div>
</div>

<div style="text-align: center; margin-top: 20px;">
  <a href="https://if36-cypher.shinyapps.io/shiny_dashboards/" target="_blank" style="display:inline-block; padding:10px 20px; background-color:#005CBF; color:white; text-decoration:none; border-radius:8px; font-weight:bold;">
    Voir l'application interactive
  </a>
</div>
...
<div class="card text-white bg-secondary mb-3" style="border-radius: 12px; max-width: fit-content; margin: auto;">   
<div class="card-body bg-white" style="padding: 1rem; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
```{r shinyapp_embed, echo=FALSE, eval=TRUE}
knitr::include_app(
  url = "https://if36-cypher.shinyapps.io/shiny_dashboards/",
  height = "700px")
```
</div>
</div>
...
## Exemple d'un graphique refait sous Tableau 

<p align ="justify">
Ce graphique est de base fait sous Shiny et a été entièrement reproduit sur Tableau, on peut voir les similitudes et les différences assez aisément, ils sont très proche en terme de résultat final.  
</p>
<div style="text-align:center;">
<img src="data/rapport/tableau_graph1.png" style="border-radius: 8px; max-width: 50%; margin-bottom: 1rem;" alt="Graphique Tableau">
</div>



## Version courte sous forme de tableau

<div style="overflow-x:auto;">
  <table style="width:100%;border-collapse:collapse;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:0.92rem;">
    <!-- En-têtes -->
    <thead>
      <tr>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;white-space:nowrap;">Critère</th>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;">Tableau</th>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;">Shiny</th>
      </tr>
    </thead>
    <tbody>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Accessibilité &amp; prise en main</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          No-code&nbsp;: premiers graphiques sans écrire de code.<br>
          Mais interface dense et peu intuitive ; courbe d’apprentissage longue, bloque vite les vrais débutants.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Exige de connaître R, donc entrée plus technique.<br>
          En contrepartie, logique claire et contrôle total pour qui maîtrise le langage.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Coût direct</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Essai gratuit 15&nbsp;jours.<br>
          Licence payante 35 – 115 € / mois / utilisateur&nbsp;: lourd pour un semestre ou une petite équipe.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Gratuit et open-source.<br>
          Dépenses limitées à l’hébergement et à la formation éventuelle.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Ressources &amp; support</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Documentation officielle soignée mais univers fermé ; communauté plus restreinte, contenus propriétaires.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Immense écosystème R, forums actifs, centaines de tutoriels et packages, aide abondante.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Collaboration &amp; versioning</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Partage de fichiers limité, pas de versioning intégré ; interdépendances fragiles, erreurs en cascade ; travail d’équipe difficile.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Code texte → Git, pull-requests, CI/CD ; collaboration selon les standards dev habituels.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Personnalisation</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Bibliothèque de visuels prête à l’emploi.<br>
          Mais plafonne vite ; limité aux options prévues par l’éditeur.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Liberté totale : UI, logique, JS, CSS, milliers de packages R.<br>
          Solution idéale pour besoins très spécifiques ou évolutifs.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Interopérabilité</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Bons connecteurs standards (Excel, SQL, etc.) mais difficile d’intégrer flux exotiques ; changer d’outil impose de tout refaire.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Presque tous les formats (CSV, JSON, XML, APIs) ; possibilité de passer de R à Python facilement.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Projets complexes &amp; scalabilité</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Très efficace pour prototypes simples.<br>
          Devient vite ingérable quand feuilles, champs calculés et dashboards se multiplient ; redémarrages fréquents.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Architecture modulaire ; peut grandir proprement si le code est bien organisé et testé.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Limites techniques (dates)</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Système de dates Excel : impossible de gérer facilement des valeurs &lt; 1900.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Aucune limite arbitraire ; dates historiques gérées nativement.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Machine Learning / Deep Learning</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Fonctions ML encore limitées en 2025 ; intégration DL complexe.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Accès direct aux bibliothèques R et Python (via reticulate) pour ML/DL avancé.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;">Impact économique long terme</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Prototypage ultra-rapide mais double coût&nbsp;: licences + ingénieurs ; risque de refonte totale à cause des limites.
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Pas de licences ; code réutilisable et maîtrisé&nbsp;; investissement surtout dans la formation initiale.
        </td>
      </tr>
    </tbody>
  </table>
...
<div class="card text-white bg-primary mb-3">
<div class="card-header">Introduction à la comparaison de Tableau et Shiny (R)</div>
<div class="card-body">
<p class="card-text">
Dans ce rapport, nous avons décidé de faire une comparaison approfondie entre les deux solutions de visualisation et d’exploitation de données : Tableau et Shiny (R).<br>
Ces deux outils ont des approches opposées : Tableau est une solution dite « no-code », promettant une utilisation simple et intuitive pour des utilisateurs sans bagage technique préalable, tandis que Shiny est une solution « full code », nécessitant une maîtrise (au moins les bases) du langage R.
</p>
</div>
</div>

<div class="card text-white bg-primary mb-3">
<div class="card-header">1. Coût et modèle économique</div>
<div class="card-body">
<p class="card-text">
Le premier aspect essentiel à considérer est la différence marquée au niveau du coût. Pour reproduire nos graphiques initialement réalisés avec Shiny, nous avons utilisé la version d’essaie de 15 jours gratuite de Tableau. Pour un travail de groupe comme celui-ci durant un semestre entier, c’est assez limité. Au-delà de cette période, l’acquisition d’une licence Tableau coûte entre 35 et 115 euros par mois et par utilisateur, représentant un investissement considérable pour une utilisation individuelle ou dans une petite équipe.<br>
À l'inverse, Shiny est une solution entièrement gratuite et open source, permettant une utilisation sans contraintes financières. De plus, le fait que se soit ouvert amène l’existence d’une vaste communauté d’utilisateurs, très active, générant continuellement une multitude de ressources techniques. Tableau, étant une solution propriétaire, ne bénéficie pas de la même abondance de ressources externes.
</p>
</div>
</div>

<div class="card text-white bg-primary mb-3">
<div class="card-header">2. Collaboration et gestion des modifications</div>
<div class="card-body">
<p class="card-text">
Le deuxième enjeu majeur dans l’utilisation de Tableau concerne les difficultés de collaboration. À l'image de nombreuses solutions no-code, Tableau rend très complexe le travail simultané sur un même projet. L’interface ne permet pas un suivi clair des modifications effectuées par plusieurs personnes, ce qui complique considérablement le partage et la gestion collaborative des fichiers. On peut s’envoyer les fichiers par des messageries, mais ça reste très limité d’un point de vue organisation collaborative, ce qui mène souvent à la réalisation d’un projet seul.<br>
En outre, Tableau, dans son utilisation, génère fréquemment des interdépendances entre les différents éléments (feuilles, tableaux de bord, champs calculés). Avec ces interdépendances, une simple modification peut provoquer une cascade d’erreurs difficiles à diagnostiquer, surtout quand on arrive dans le projet en cours de route, ou qu’on reprend le travail après quelqu’un d’autre sur une base déjà existante. De plus, Tableau ne dispose d'aucune solution intégrée de versionnage, obligeant les équipes à maintenir des environnements distincts de développement test et de production pour limiter les risques.<br>
Ce manque de gestion efficace des modifications et des versions provient surtout d'une incompatibilité entre des solutions propriétaires comme Tableau et les méthodes de développement modernes, reposant sur des outils de référence tels que Git, largement adoptés dans le secteur du développement logiciel. En effet, il serait impossible de recréer, ou extrêmement difficile de recréer un environnement aussi optimisé que Git dans un outil propriétaire.
</p>
</div>
</div>

<div class="card text-white bg-primary mb-3">
<div class="card-header">3. Complexité réelle des solutions no-code : promesse trompeuse de simplicité</div>
<div class="card-body">
<p class="card-text">
La promesse centrale des solutions no-code (Ici, Tableau) est celle d'une simplification radicale, permettant à tout utilisateur, même novice, voire complètement inconnu au monde du code ou de la datascience, de réaliser facilement des analyses avancées. Cependant, cette promesse est trompeuse. Certes, contrairement à Shiny, Tableau ne demande pas une maîtrise préalable d’un langage de programmation, comme R ou Python (largement utilisé dans la datascience aussi), mais l’interface elle-même reste difficile à appréhender pour les débutants.<br>
Tableau rassemble un très grand nombre de fonctionnalités au sein d’une même interface graphique en voulant avoir autant de possibilité que du code. Cette densité d’options engendre une courbe d’apprentissage longue, et l’utilisateur découvre souvent au fil de son expérience qu’il n’exploite pas l’outil de façon optimale, voir qu’il ne pourra pas terminer son projet, entraînant du découragement et des coûts de production à rallonge en terme de temps, énergie et économique. En pratique, il arrive que les utilisateurs se retrouvent bloqués par des problèmes techniques inattendus, les obligeant à recommencer intégralement leur travail dès que les projets atteignent une certaine complexité. Au moment où l'on multiplie les feuilles, les champs calculés, ou les tableaux de bord, Tableau devient souvent ingérable, amenant finalement les utilisateurs à basculer vers du code réel.
</p>
</div>
</div>

<div class="card text-white bg-primary mb-3">
<div class="card-header">4. Interopérabilité : ouverture technique versus limitations propriétaires</div>
<div class="card-body">
<p class="card-text">
L’interopérabilité constitue également un point clé dans la comparaison. Tableau, solution fermée, gère bien les formats et connecteurs standards, mais quand il s'agit d'intégrer des données moins communes ou nécessitant des prétraitements spécifiques, l’utilisateur est rapidement limité et bloqué par les contraintes imposées par l’outil.<br>
À l’opposé, Shiny, bénéficiant de la flexibilité du langage R, offre une compatibilité quasi illimitée avec divers formats de données (CSV, JSON, XML, bases de données SQL, API web…). Cette souplesse technique est décisive dans les contextes réels où les données proviennent souvent de sources multiples et hétérogènes. Aussi, si on veut changer le code de R à python par exemple, une simple translation de langage est possible. En revanche, si on veut changer d’outil et qu’on a commencé sur Tableau, il faut tout recommencer de zéro.
</p>
</div>
</div>

<div class="card text-white bg-primary mb-3">
<div class="card-header">5. Personnalisation et adaptabilité des visualisations</div>
<div class="card-body">
<p class="card-text">
Concernant la personnalisation, les différences sont significatives. Tableau permet certes des visualisations avancées, comme on peut le voir plus haut sur le graphique reproduit sur Tableau, mais a rapidement des limites dans la capacité à répondre à des besoins très spécifiques ou innovants. Les utilisateurs atteignent rapidement un plafond technique lorsqu’il s’agit d'intégrer des logiques personnalisées ou complexes. D’ailleurs, la personnalisation est limitée à ce que Tableau a intégré à son outil.<br>
Shiny offre quant à lui une liberté totale en termes de personnalisation, tout aspect, de la structure des graphiques aux interactions utilisateur, est entièrement adaptable par code. Bien sûr, cela implique des compétences techniques plus poussées, mais garantit aussi un résultat parfaitement aligné avec les exigences spécifiques des projets ambitieux. En somme, pour du long terme, il vaudra toujours mieux utiliser Shiny R que Tableau car la personnalisation possible est plus vaste (beaucoup plus poussée avec les centaines de bibliothèques que R possède).
</p>
</div>
</div>

<div class="card text-white bg-primary mb-3">
<div class="card-header">6. Implications économiques et techniques à long terme des solutions no-code</div>
<div class="card-body">
<p class="card-text">
Enfin, une réflexion importante porte sur les implications économiques réelles du choix d'une solution no-code comme Tableau. Bien qu’initialement séduisantes au vu de sa simplicité, ces solutions s'adressent rarement à des débutants complets, ou en tout cas, elles s’adressent à des débutants complets en apparence, mais sont inaccessibles pour eux. Les utilisateurs réels doivent généralement disposer d’une expérience préalable dans l’exploitation des données ou d’une logique de développeur pour exploiter toutes les possibilités offertes par l’outil. Voir une spécialisation en outil no-code (métier en popularisation/apparition depuis 2019)<br>
Une entreprise choisissant Tableau doit non seulement payer le coût élevé des licences, mais aussi prévoir de maintenir ou recruter des ingénieurs et développeurs capables d’accompagner techniquement les équipes, même souvent, d’utiliser les solutions no-code. Cet investissement double constitue un désavantage économique majeur, aggravé par le fait qu’à terme, lorsque les limites techniques seront atteintes, l’entreprise devra probablement engager des développeurs supplémentaires pour tout refaire avec du vrai code, entraînant aussi le paiement potentiel de formation et adaptation aux nouveaux outils utilisés par l’entreprise.<br>
À titre d’exemple, Tableau utilise le même système de dates qu'Excel, empêchant ainsi de traiter facilement des données antérieures à 1900. Ce genre de contrainte peut devenir rapidement très problématique, en particulier dans les projets nécessitant l’analyse de données historiques ou anciennes.<br>
Ainsi, la vente initiale de simplicité du no-code cache des coûts techniques lourds, réduisant fortement son intérêt économique réel à moyen ou long terme, en comparaison à des solutions open source comme Shiny, qui offrent à la fois flexibilité et maîtrise technique complète, malgré le besoin initial de connaître le langage qui peut rebuter les débutants du domaine.
</p>
</div>
</div>
<div class="card text-white bg-primary mb-3">
...
<div class="card-body">
<p class="card-text">
Tableau et Shiny répondent à des besoins et contextes d’utilisation très distincts. Tableau séduit initialement par sa simplicité apparente, mais présente rapidement des limitations citées au-dessus. À l’inverse, Shiny demande un investissement initial en compétence, mais garantit une maîtrise totale et une évolutivité quasi illimitée.<br><br>
Le choix entre ces deux solutions dépendra donc des objectifs à long terme, du budget disponible et des compétences techniques existantes ou à développer au sein de l’équipe. Il n’y a quasiment pas de valeur ajoutée à la solution Tableau, si ce n’est de faire du prototypage extrêmement rapide. Et encore, cet argument fonctionne pour des solutions comme Bubble, qui permette de créer des applications. Beaucoup moins pour une solution qui propose de la data science/ visualisation/ analyse de données. De plus, continuer sur du ML / DL est encore vraiment compliqué sur Tableau, ce qui fait parti des choses en vogues en 2025.
</p>
</div>
</div>
# Bibliographie  
<div style="overflow-x:auto;">
  <table style="width:100%;border-collapse:collapse;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:0.92rem;">
    <thead>
      <tr>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;white-space:nowrap;">Organisme&nbsp;/&nbsp;média</th>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;">Lien cliquable</th>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;">Date</th>
        <th style="background:linear-gradient(135deg,#007bff 0%,#6610f2 100%);color:#fff;text-align:center;padding:0.75rem;border:1px solid #dee2e6;">Ce que la source éclaire</th>
      </tr>
    </thead>
    <tbody>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">TF1&nbsp;Info</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.tf1info.fr/transports/video-reportage-retard-des-trains-tgv-intercites-transilien-ter-comment-la-sncf-minimise-leur-nombre-grace-a-une-methode-de-calcul-avantageuse-2308217.html" target="_blank">
            Reportage&nbsp;: méthode de calcul avantageuse
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">11&nbsp;juil.&nbsp;2024</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Décrit les seuils 5/10/15&nbsp;min qui minimisent les retards, point soulevé dans notre rapport.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Vie-publique</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.vie-publique.fr/en-bref/296125-trains-et-avions-en-2023-une-ponctualite-degradee-pour-les-voyageurs" target="_blank">
            Ponctualité dégradée pour les voyageurs
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">janv.&nbsp;2025</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Confirme la baisse de ponctualité observée depuis&nbsp;2019 dans nos analyses.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Le&nbsp;Monde</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.lemonde.fr/economie/article/2024/07/11/les-methodes-de-la-sncf-pour-camoufler-une-partie-de-ses-retards_6248470_3234.html" target="_blank">
            Méthodes pour camoufler les retards
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">11&nbsp;juil.&nbsp;2024</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Corrobore le biais de calcul exposé dans l’étude.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Le&nbsp;Point</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.lepoint.fr/societe/comment-la-sncf-maquille-ses-statistiques-de-ponctualite-25-09-2023-2536789_23.php" target="_blank">
            Comment la SNCF maquille sa ponctualité
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">25&nbsp;sept.&nbsp;2023</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Soutient la critique des chiffres officiels présentée dans le rapport.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">TF1&nbsp;Info</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.tf1info.fr/transports/video-tf1-pour-la-sncf-seul-1-train-sur-9-est-en-retard-vraiment-2308266.html" target="_blank">
            «&nbsp;1&nbsp;train sur&nbsp;9&nbsp;en retard&nbsp;?&nbsp;»
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">juil.&nbsp;2024</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Illustre l’écart entre statistique et vécu voyageur mis en lumière dans nos conclusions.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Autorité&nbsp;de&nbsp;régu.&nbsp;des&nbsp;transports</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.autorite-transports.fr/actualites/publication-du-rapport-dactivite-2023-de-lautorite-de-regulation-des-transports/" target="_blank">
            Rapport d’activité&nbsp;2023
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">févr.&nbsp;2024</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Sert de référentiel national pour comparer nos indicateurs de ponctualité.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Reporterre</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://reporterre.net/Un-TGV-au-dessus-du-vide-symbole-d-un-reseau-ferre-vulnerable-aux-intemperies" target="_blank">
            Réseau ferré vulnérable aux intempéries
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">juil.&nbsp;2022</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Étaye la corrélation météo&nbsp;/ retards cartographiée dans le rapport.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">BFMTV</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <em>Plan canicule&nbsp;: pourquoi les TGV roulent moins vite (août&nbsp;2023)</em>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">août&nbsp;2023</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Explique la baisse de vitesse estivale, confirmant nos pics de retard saisonniers.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">SNCF&nbsp;(réseaux sociaux)</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">—</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">19&nbsp;mai&nbsp;2023</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Communiqué Ascension&nbsp;2023 sur trafic dense, apportant un exemple d’effet «&nbsp;week-end prolongé&nbsp;».
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Le&nbsp;Figaro</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.lefigaro.fr/conjoncture/greve-les-francais-commencent-a-en-avoir-ras-le-bol-de-ce-qu-il-se-passe-a-la-sncf-selon-le-ministre-de-transports-20250502" target="_blank">
            Grève&nbsp;: lassitude des voyageurs
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">02&nbsp;mai&nbsp;2025</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Souligne l’impact des mouvements sociaux sur les retards, thème étudié dans notre analyse.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Le&nbsp;Parisien</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.leparisien.fr/economie/sncf-appel-a-la-greve-les-4-5-et-11-juin-preavis-pour-lete-les-prochaines-semaines-sannoncent-tendues-02-06-2025-SWJR7XORJFEK7MLFMK5MTHQN2A.php" target="_blank">
            Appel à la grève&nbsp;: un été sous tension
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">02&nbsp;juin&nbsp;2025</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Anticipe les retards estivaux liés aux préavis, cohérent avec nos pics saisonniers.
        </td>
      </tr>
      <tr>
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">ART&nbsp;(PDF)</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://www.autorite-transports.fr/wp-content/uploads/2025/06/bilan-ferroviaire-france-2024_plaquette-a-mi-annee.pdf" target="_blank">
            Bilan ferroviaire France&nbsp;2024 (mi-année)
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">juin&nbsp;2025</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Actualise les indicateurs nationaux utilisés comme référence dans nos comparaisons.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Rail&nbsp;du&nbsp;Sud (blog)</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://raildusud.canalblog.com/archives/2024/01/31/40185887.html" target="_blank">
            Paris-Briançon&nbsp;: 9&nbsp;h et souvent en retard
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">31&nbsp;janv.&nbsp;2024</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Cas concret illustrant la faible corrélation durée&nbsp;/ retard évoquée dans nos graphiques.
        </td>
      </tr>
      <tr style="background-color:#f8f9fa;">
        <th style="font-weight:600;background-color:#e2e6ea;border:1px solid #dee2e6;padding:0.6rem 0.8rem;white-space:nowrap;">Moselle&nbsp;TV</th>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          <a href="https://moselle.tv/la-sncf-est-elle-toujours-en-retard/" target="_blank">
            La SNCF est-elle toujours en retard&nbsp;?
          </a>
        </td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">nov.&nbsp;2024</td>
        <td style="border:1px solid #dee2e6;padding:0.6rem 0.8rem;">
          Met en avant pannes d’aiguillage et rails vétustes, confortant la part «&nbsp;infrastructure&nbsp;» dominante dans nos causes.
        </td>
      </tr>
    </tbody>
  </table>
