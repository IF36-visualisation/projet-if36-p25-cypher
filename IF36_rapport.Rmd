...
carte_ete <- leaflet(retards_ete) %>%
  ...
  addLegend("bottomright", pal = pal, values = ~avg_delay,
            title = "Retard moyen (été)",
...
carte_hiver <- leaflet(retards_hiver) %>%
  ...
  addLegend("bottomright", pal = pal, values = ~avg_delay,
            title = "Retard moyen (hiver)",
            labFormat = labelFormat(suffix = " min"))
div(
  style = "display: flex; gap: 20px;",
  div(style = "width: 50%;", carte_ete),
  div(style = "width: 50%;", carte_hiver)
)
